...
namespace ReservationServiceDAL.Migrations
{
    ...
    [Migration("20241104215458_InitialCreate")]
            ...
            modelBuilder.Entity("ReservationServiceDAL.Entities.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ShowtimeId = 2,
                            TicketTypeId = 1,
                            TimeOfReservation = new DateTime(2024, 11, 4, 21, 54, 58, 287, DateTimeKind.Utc).AddTicks(7406),
                            TotalCost = 0m,
                            isCancelable = true
                        },
                        new
                        {
                            ...
                            ShowtimeId = 2,
                            TicketTypeId = 2,
                            TimeOfReservation = new DateTime(2024, 11, 4, 21, 54, 58, 287, DateTimeKind.Utc).AddTicks(8757),
                            TotalCost = 0m,
                            isCancelable = true
                        },
                        new
                        {
                            ...
                            ShowtimeId = 4,
                            TicketTypeId = 1,
                            TimeOfReservation = new DateTime(2024, 11, 4, 21, 54, 58, 287, DateTimeKind.Utc).AddTicks(8764),
                            TotalCost = 0m,
                            isCancelable = true
                        },
                        new
                        {
                            ...
                            ShowtimeId = 2,
                            TicketTypeId = 3,
                            TimeOfReservation = new DateTime(2024, 11, 4, 21, 54, 58, 287, DateTimeKind.Utc).AddTicks(8766),
                            TotalCost = 0m,
                            isCancelable = false
                        });
                });
